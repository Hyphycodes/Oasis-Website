 ...
 * depended on how you happened to describe what you wanted. Tacos sat beside
 * Plates when a taco dinner IS a plate. Margaritas sat beside The bar when a
 * margarita comes FROM the bar. A guest should never have to work out which of
...
const DOORS: Door[] = [
  {
    label: 'Food',
    note: 'Birria, quesabirrias, tacos, plates and tortas',
    href: '/menu#food',
      ...
      <Frame wide>
        ...
        <Reveal delay={90}>
          <div className="relative mt-7 flex justify-start">
            ...
            <ThemePhotoGuest name="kitty" className="theme-photo-guest-beside" />
          </div>
        </Reveal>
      </Frame>
    </Band>
