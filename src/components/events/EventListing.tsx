...
/**
 * The three sizes an event is published at.
 *
 * Not everything is equally big, on purpose. A calendar where every night is a
 * large card is a calendar that has no opinion, and a restaurant with a
 * Halloween headliner and a Tuesday paint night does have one.
 *
 *   EventBanner   the one event the page opens with — full-bleed, type over art
 *   EventCard     a month that deserves attention (October) — art on top
 *   EventRow      the ordinary calendar line — a thumbnail, a date, a name
 */
