...
/**
 * Apply to work at Oasis, in about two minutes.
 *
 * Five things are asked for and the rest is optional, in that order, because
 * everything below the fold is a reason to give up. There is no cover letter,
 * no "years of experience", no address and no references — all of which Oasis
 * can ask in the phone call this form is trying to cause.
 *
 * The position is chosen by id, not typed: the server looks the opening up
 * and stores its real title, so a form cannot invent a job.
 */
export function ApplyForm({
  ...
  return (
    <FormShell
      ...
      privacyNote="Your application is read by the Oasis team and nobody else."
      success={{
        title: 'Got it — thanks for putting your name in.',
        body: (
          <p>
            Somebody at Oasis reads every one of these.
