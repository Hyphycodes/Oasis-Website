...
export function TalentForm({ phone }: { phone: string }) {
  ...
  return (
    <FormShell
      ...
      privacyNote="This goes to the Oasis team. We never publish anything you send without asking you first."
      success={{
        title: 'We got it.',
        body: (
          <p>
    ...
    >
      ...
      <TextArea
        ...
        required
        rows={3}
        placeholder="Open-format Latin sets — reggaetón, cumbia, a bit of house late."
      ...
      <details className="group rounded-(--radius-md) border border-brown/20 bg-linen/50">
        ...
        <div className="grid gap-5 border-t border-brown/12 px-4 py-5">
          ...
          <TextArea
            name="idea"
            label="What would you want to do at Oasis?"
            rows={3}
            placeholder="A Thursday residency, a mural on the patio wall, a paint night for Día de Muertos…"
