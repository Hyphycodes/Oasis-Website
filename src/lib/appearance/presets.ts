...
export const PRESETS = ['evening', 'fiesta', 'muertos', 'daylight'] as const;
export type PresetName = (typeof PRESETS)[number];

export const SEASONS = ['none', 'halloween', 'muertos', 'winter', 'spring'] as const;
...
export const PRESET_DEFINITIONS: Record<PresetName, PresetDefinition> = {
  ...
  muertos: {
    ...
    hint: 'Deep plum and marigold. Pairs with the papel picado and the petals.',
