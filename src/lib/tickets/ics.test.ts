...
describe('buildIcs', () => {
  const ics = buildIcs(
    {
      uid: 'OAS-7K4M2@oasis',
      title: 'Hello Kitty Fall Paint & Lunch',
      startsAt: '2026-09-19T17:00:00.000Z',
      endsAt: '2026-09-19T20:00:00.000Z',
      location: 'Oasis Mexican Kitchen & Bar, 1250 E. 9th St., Lockport, IL 60441',
      description: 'Order OAS-7K4M2. Tickets: H7K4-M2Q9, PX2N-4R8T',
      url: 'https://example.com/tickets/OAS-7K4M2',
    },
  ...
  it('escapes commas in the address', () => {
    ...
    expect(unfolded).toContain('LOCATION:Oasis Mexican Kitchen & Bar\\, 1250 E. 9th St.\\, Lockport\\, IL 60441');
