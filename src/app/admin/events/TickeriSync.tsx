...
/**
 * Bring the calendar in from Tickeri.
 *
 * Staff press this; nothing does it automatically and no guest's page ever
 * waits on Tickeri. It is written to be safe to press twice: events are matched
 * on Tickeri's own id, so a second run corrects what changed instead of adding
 * a second copy of the same night.
 */
