  ...
  return (
    <form action={action} className="grid gap-5">
      <div className="grid gap-4 sm:grid-cols-2">
        <label className="grid gap-1.5 text-[0.875rem] font-semibold text-brown">Hub name<input name="name" required maxLength={100} placeholder="Oasis Live" className="min-h-11 rounded-(--radius-sm) border border-brown/25 bg-ivory px-3 font-normal" /></label>
