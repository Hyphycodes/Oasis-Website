 ...
 * Job openings.
 *
 * The whole screen is a list of switches. A role that is on is on the
 * website; a role that is off is a draft nobody can see, which is how all
 * nine of the standard restaurant roles ship — typed out so nobody has to
 * type them, and switched off so the website never advertises a job Oasis is
 * not filling.
 *
 * Archiving, not deleting: applications point at an opening and have to keep
        ...
        <div className="grid grid-cols-1 gap-5">
          ...
          <Card title="Switched off" tone="quiet">
            <HelpNote>
              ...
              it on — nothing here is visible to anybody outside Oasis.
            </HelpNote>
            {off.length === 0 ? (
