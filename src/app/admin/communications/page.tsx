      ...
      <div className="grid gap-5">
        <Card title="Status">
          <dl className="grid gap-3 sm:grid-cols-2">
            ...
            <Status ok={config.authHookSecretSet} label="Staff sign-in emails" detail={config.authHookSecretSet ? 'Sent as Oasis emails through the Supabase auth hook.' : 'Supabase sends its own plain sign-in and invitation emails until the auth hook is pointed here.'} neutral={!config.authHookSecretSet} />
          </dl>
