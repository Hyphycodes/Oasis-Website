 ...
 * One talent profile.
 *
 * Everything they sent, on one screen, with their links clickable and their
 * photographs actually shown — the whole point of this system is that
 * somebody at Oasis can look at a person's work in ten seconds and decide.
 *
 * The private files are served through /admin/files, which checks the
 * signed-in staff member and then mints a short-lived signed URL. There is no
 * public URL for any of this.
 */
