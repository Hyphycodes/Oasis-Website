...
/**
 * The two things staff actually do with a talent profile: move it along with
 * a note, and — once it is real — put the person on the contractor roster.
 *
 * "Add to the roster" is the whole reason this is not a second CRM. It
 * creates the `contractors` row Oasis already books, pays and chases a W-9
 * from, and links the two records, so nobody keeps two lists of the same DJ.
 */
