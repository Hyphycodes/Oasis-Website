 ...
 * Create with Oasis.
 *
 * The room already runs paint nights, DJ nights, comedy and live music, and
 * most of that arrived because somebody walked up and said what they do. This
 * page is that conversation, written down: a dark opener that reads like an
 * invitation rather than an application, the kinds of people we want to hear
 * from as plain chips, and a form short enough to finish at a bus stop.
 *
 * What it is deliberately NOT: a proposal, a rate card, a booking request or
 * a submission portal. Nobody is asked for a bio, a rider, or availability —
 * those are a conversation, and this page exists to start one.
 */
            ...
            <div className="grid gap-10 lg:grid-cols-12 lg:gap-12">
              <div className="lg:col-span-5">
                ...
                <p className="measure mt-5 text-[0.9375rem] leading-relaxed text-brown-soft">
                  Paint nights, DJ sets, live music, comedy, photography, a wall that needs a
