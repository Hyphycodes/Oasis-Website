...
export const metadata: Metadata = buildMetadata({
  title: 'Ticket terms — Oasis Mexican Kitchen & Bar',
  description: 'What a ticket to an Oasis event gets you, our refund policy, age rules, and what happens if an event changes.',
  path: '/legal/tickets',
});
        ...
        <Frame>
          <div className="measure space-y-8 text-[0.9375rem] leading-relaxed text-brown-soft">
            <section>
              ...
              <p className="mt-3">
                A seat at the event named on it, on the date and time it says, at {site.name}, {site.street}, {site.locality}. Anything the event page lists as included — a canvas, paints, brunch — is included. Food and drink beyond that is bought as usual.
              </p>
            </section>
            <section>
