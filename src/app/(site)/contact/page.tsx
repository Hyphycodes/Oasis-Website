 ...
 * Contact.
 *
 * Three movements and nothing else:
 *
 *   1. VISIT — where Oasis is, whether it is open, and how to get there. It
 *      is the whole top of the page because almost everybody who opens a
 *      restaurant's contact page is trying to come and eat. There is no
 *      "how can we help you" chooser and nothing about employment above the
 *      fold.
 *   2. WORK AT OASIS — smaller, warmer, and only ever showing roles somebody
 *      has actually switched on.
 *   3. CREATE WITH OASIS — the invitation to local DJs, artists and
 *      performers, on a dark band so it reads as a different kind of ask.
 *
 * Each one is a preview with one way in; the forms live on their own pages,
 * so this page stays short enough to read on a phone in a car park.
 */
