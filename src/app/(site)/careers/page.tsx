 ...
 * Work at Oasis.
 *
 * The page answers the two questions somebody has in this order — what is
 * open, and how do I put my name in — and then, only then, tells them what
 * the job is like. The order matters: a page that opens with three paragraphs
 * about culture before naming a single role is a page about the restaurant,
 * not about them.
 *
 * NOTHING HERE CLAIMS OASIS IS HIRING. The openings come from the database
 * and ship switched off, so a fresh install shows the honest empty state and
 * still takes an open application, which is a real thing a restaurant does.
 */
