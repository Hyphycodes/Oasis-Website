...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  return {
    title: `${page.hub.title} — Oasis Mexican Kitchen & Bar`,
    description: page.hub.subtitle || page.hub.internalDescription || 'Oasis links, events and guest actions.',
    ...
    openGraph: {
      ...
      description: page.hub.subtitle || 'Oasis Mexican Kitchen & Bar',
