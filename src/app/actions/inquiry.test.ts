...
function form() { const data = new FormData(); Object.entries({name:'QA Test',email:'qa@example.com',phone:'8155550100',date:'2026-09-20',guests:'20',fulfillment:'pickup'}).forEach(([k,v])=>data.set(k,v)); return data; }
