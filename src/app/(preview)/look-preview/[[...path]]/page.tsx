...
export const metadata: Metadata = { title: 'Look preview — Oasis Admin', robots: { index: false, follow: false, nocache: true } };

/**
 * The real pages, in a frame, for /admin/look.
 *
 * Staff only. The frame renders exactly what a guest gets — same chrome,
 * same theme — and the editor repaints it by posting variables in. It lives
 * OUTSIDE /admin on purpose: the admin layout re-declares the colour tokens on
 * its own element, which would beat anything posted onto <html>. Nothing here
 * is cached and nobody but staff can open it.
 */
