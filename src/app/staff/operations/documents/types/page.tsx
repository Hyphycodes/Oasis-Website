...
/** The list of things Oasis asks of an employee, and the form to add or change one. Nothing legal is asserted here. */
export default async function RequirementTypesPage({ searchParams }: { searchParams: Promise<{ edit?: string }> }) {
  ...
  return (
    <StaffShell context={context} unread={unread} wide>
      ...
      <Screen title="Requirements" lead="Documents, policies, certifications and onboarding steps. Each is a slot Oasis fills with its own form, link or policy — nothing here decides what the law requires.">
