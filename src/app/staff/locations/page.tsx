...
/** Owner: every Oasis, and the form for the next one. */
export default async function LocationsPage({ searchParams }: { searchParams: Promise<{ edit?: string }> }) {
  ...
  return (
    <StaffShell context={context} unread={unread}>
      <Screen title="Locations" lead="Lockport today. Joliet is a row here, not a rebuild: employees, shifts, events, tasks and announcements can all belong to it.">
