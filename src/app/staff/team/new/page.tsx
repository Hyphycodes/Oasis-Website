...
export default async function NewEmployeePage() {
  ...
  return (
    <StaffShell context={context} unread={unread}>
      ...
      <Screen title="Add an employee" lead="They get an invitation, a welcome email, their onboarding checklist and any required training. Nothing legal is assumed: the checklist is whatever Oasis put in it.">
