...
/** Welcome to Oasis: the checklist, one item at a time, each completable in place. */
export default async function OnboardingPage() {
  ...
  return (
    <StaffShell context={context} unread={unread}>
      <Screen title={progress?.stage === 'ready' ? 'You’re ready.' : `Welcome to Oasis${employee ? `, ${employee.displayName}` : ''}.`} lead={progress?.stage === 'ready' ? 'Everything on your checklist is done. Your manager confirms your first shift from here.' : 'A few things before your first shift. Most take a minute; do them in any order.'}>
