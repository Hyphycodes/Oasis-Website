 ...
 * Today at Oasis.
 *
 * The order is the order the questions get asked: am I working, what is on
 * tonight, what is left to do, did anyone say anything, when am I next in.
 * Nothing on this screen is a card for its own sake, and nothing is here
  ...
  return (
    <StaffShell context={context} unread={unread}>
      <div className="grid gap-7">
        <header>
          <p className="text-[0.75rem] font-semibold uppercase tracking-[0.14em] text-brown-soft">Today at Oasis</p>
        ...
        {home.tonight.length > 0 ? (
          <Section title={home.tonight.length === 1 ? 'Tonight' : 'Tonight at Oasis'}>
