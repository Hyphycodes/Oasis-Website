...
import { Artwork, EventDetails, EventHero, NoticeBox, OasisEmailLayout, OasisHeader, OrderSummary, PrimaryButton, TicketList } from '../components';
...
function Pass(props: TicketConfirmationProps) {
  ...
  const surface = 'dark';
  return (
    <OasisEmailLayout preview={preheader(props)} surface={surface} brand={brand} test={test} footerReason={`Sent to ${customer.email} because tickets were bought for this event.`}>
      <OasisHeader brand={brand} surface={surface} eyebrow="Your tickets" />
...
function Editorial(props: TicketConfirmationProps) {
  ...
  return (
    <OasisEmailLayout preview={preheader(props)} surface={surface} brand={brand} test={test} footerReason={`Sent to ${customer.email} because tickets were bought for this event.`}>
      <OasisHeader brand={brand} surface={surface} align="center" />
...
function Poster(props: TicketConfirmationProps) {
  ...
  return (
    <OasisEmailLayout preview={preheader(props)} surface={surface} brand={brand} test={test} footerReason={`Sent to ${customer.email} because tickets were bought for this event.`}>
      <OasisHeader brand={brand} surface={surface} eyebrow="Your tickets" compact />
