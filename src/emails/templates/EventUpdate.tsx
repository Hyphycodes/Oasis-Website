...
import { EventDetails, EventHero, InfoRow, InfoTable, NoticeBox, OasisEmailLayout, OasisHeader, PrimaryButton, TicketList } from '../components';
...
export default function EventUpdate(props: EventUpdateProps) {
  ...
  return (
    <OasisEmailLayout preview={preheader(props)} surface={surface} brand={brand} test={test} footerReason={`Sent to ${customer.email} because you have tickets for this event.`}>
      <OasisHeader brand={brand} surface={surface} eyebrow={spec.eyebrow} />
