...
import { EventDetails, EventHero, NoticeBox, OasisEmailLayout, OasisHeader, PrimaryButton, TicketList } from '../components';
...
export default function EventReminder(props: EventReminderProps) {
  ...
  return (
    <OasisEmailLayout preview={preheader(props)} surface={surface} brand={brand} test={test} footerReason={`Sent to ${customer.email} because you have tickets for this event.`}>
      <OasisHeader brand={brand} surface={surface} eyebrow="Reminder" />
