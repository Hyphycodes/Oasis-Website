...
import { EventHero, OasisEmailLayout, OasisHeader, PrimaryButton, TicketList, VenueDetails } from '../components';
...
export default function TicketResend(props: TicketResendProps) {
  ...
  const surface = 'dark';
  return (
    <OasisEmailLayout preview={preheader(props)} surface={surface} brand={brand} test={test} footerReason={`Sent to ${customer.email} because these tickets were requested again.`}>
