...
/**
 * "You have been added to the Oasis admin." The link is a Supabase Auth
 * invitation, so accepting it proves the mailbox and creates the session;
 * the profile row with the role already exists. No password is chosen here
 * and none is ever emailed.
 */
