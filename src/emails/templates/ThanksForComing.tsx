...
import { EventHero, OasisEmailLayout, OasisHeader, PrimaryButton } from '../components';
...
export default function ThanksForComing(props: ThanksForComingProps) {
  ...
  return (
    <OasisEmailLayout preview={preheader(props)} surface={surface} brand={brand} test={test} footerReason={`Sent to ${customer.email} because you came to this event.`}>
      <OasisHeader brand={brand} surface={surface} compact />
