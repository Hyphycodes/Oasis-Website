...
import { InfoRow, InfoTable, NoticeBox, OasisEmailLayout, OasisHeader, OrderSummary, PrimaryButton } from '../components';
...
export default function RefundConfirmation(props: RefundConfirmationProps) {
  ...
  return (
    <OasisEmailLayout preview={preheader(props)} surface={surface} brand={brand} test={test} footerReason={`Sent to ${customer.email} about order ${order.orderNumber}.`}>
      <OasisHeader brand={brand} surface={surface} eyebrow="Refund" />
