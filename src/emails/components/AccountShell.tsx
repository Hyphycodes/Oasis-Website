...
import { OasisEmailLayout } from './OasisEmailLayout';
import { OasisHeader } from './OasisHeader';
...
export function AccountShell({
  ...
  return (
    <OasisEmailLayout preview={preview} surface={surface} brand={brand} test={test} footerReason={footerReason}>
