...
export type HubTheme = 'oasis-default' | 'evening' | 'teal' | 'plum' | 'seasonal' | 'custom';
...
export type HubTemplate = 'main-links' | 'live' | 'paint-and-sip' | 'nightlife' | 'artist' | 'hiring' | 'blank';
