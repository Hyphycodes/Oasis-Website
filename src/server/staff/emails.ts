...
/**
 * The email channel for staff notifications.
 *
 * Only the kinds worth an inbox get one; the rest stay in-app. The mapping
 * is here, in one table, so "why did I get an email about that" has one
 * answer. Every send goes through the Oasis email service, lands in
 * `email_log`, and respects the employee's own email preference.
 */
