...
const account: Staff = { id: 'local-staff', email: 'carlos@oasis.local', name: 'Carlos', role: 'staff', sections: [], active: true, source: 'local' };
...
beforeEach(async () => {
  directory = await mkdtemp(path.join(tmpdir(), 'oasis-report-'));
