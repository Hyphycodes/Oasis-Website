...
vi.mock('../owner-onboarding',()=>({INITIAL_OWNER_EMAIL:'jerrysanchezpro@gmail.com',normalizeEmail:(s:string)=>s,findAuthUser:vi.fn(),completeOwnerOnboarding:mocks.complete}));
