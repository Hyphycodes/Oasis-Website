...
export interface EmailConfig {
  ...
  /** "Oasis Mexican Kitchen & Bar <tickets@…>", or null when unusable. */
  from: string | null;
...
export const DEFAULT_FROM_NAME = 'Oasis Mexican Kitchen & Bar';
...
export function emailConfig(): EmailConfig {
  ...
  return {
    transportConfigured: Boolean(env('RESEND_API_KEY')),
    ...
    deliveryEnabled: env('EMAIL_DELIVERY_ENABLED') === 'true',
