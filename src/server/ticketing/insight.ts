...
/**
 * The list Tickeri currently owns.
 *
 * Lifetime figures are summed from paid orders each time rather than stored on
 * the customer, so a refund is reflected the moment it happens.
 */
