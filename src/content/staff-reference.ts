...
import { lockport } from './locations';
...
export const REFERENCE_LOCATIONS: Row[] = [
  {
    ...
    slug: lockport.slug,
    name: lockport.name,
    short_name: lockport.shortName,
    street: lockport.street,
    locality: lockport.locality,
    region: lockport.region,
    postal_code: lockport.postalCode,
    timezone: lockport.timezone,
    phone: lockport.phone,
    active: true,
    sort: 0,
  },
];
...
export const REQUIREMENT_IDS = {
  welcome: '0a515000-0000-4000-8000-0000000000a1',
  personalDetails: '0a515000-0000-4000-8000-0000000000a2',
  emergencyContact: '0a515000-0000-4000-8000-0000000000a3',
  availability: '0a515000-0000-4000-8000-0000000000a4',
  positions: '0a515000-0000-4000-8000-0000000000a5',
  location: '0a515000-0000-4000-8000-0000000000a6',
  uniform: '0a515000-0000-4000-8000-0000000000a7',
  policies: '0a515000-0000-4000-8000-0000000000a8',
  payroll: '0a515000-0000-4000-8000-0000000000a9',
  foodHandler: '0a515000-0000-4000-8000-0000000000b1',
  basset: '0a515000-0000-4000-8000-0000000000b2',
  firstShift: '0a515000-0000-4000-8000-0000000000b3',
} as const;

export const REFERENCE_REQUIREMENT_TYPES: Row[] = [
  requirement(REQUIREMENT_IDS.welcome, { slug: 'welcome', title: 'Welcome to Oasis', description: 'Read the welcome note and what to expect in your first week.', category: 'handbook', kind: 'acknowledgement', required: true, onboarding: true, sort: 0 }),
  ...
  requirement(REQUIREMENT_IDS.foodHandler, { slug: 'food-handler', title: 'Food handler certificate', description: 'Upload your certificate. Required for kitchen and food-running positions where Oasis policy says so.', category: 'certification', kind: 'upload', required: false, onboarding: true, sort: 90, expires_after_days: 1095, applies_to_positions: ['kitchen', 'server', 'busser'] }),
  requirement(REQUIREMENT_IDS.basset, { slug: 'basset', title: 'BASSET / alcohol service', description: 'Upload your BASSET card. Whether it is required per position is an Oasis policy setting.', category: 'certification', kind: 'upload', required: false, onboarding: true, sort: 100, expires_after_days: 1095, applies_to_positions: ['bartender', 'server', 'manager'] }),
