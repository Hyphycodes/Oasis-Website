...
export const assets = {
  ...
  /* ----------------------------------------------------------------- menu */
  dishQuesabirria: {
    path: '/media/menu/quesabirria.jpg',
    kind: 'image',
    alt: 'A plate of quesabirria tacos with a cup of consommé for dipping',
    width: 720,
    height: 900,
    ratio: '4:5',
    focal: '50% 50%',
    status: 'temp-wix',
    usage: ['Homepage signatures', '/menu'],
  ...
  consommeDip: {
    ...
    kind: 'image',
    alt: 'A quesabirria taco being dipped into a cup of consommé',
    width: 720,
    height: 900,
    ratio: '4:5',
    focal: '50% 45%',
    status: 'temp-wix',
    usage: ['Homepage hero mosaic', 'Homepage signatures'],
    source: { url: 'Frame from the Oasis brand reel (see heroVideo)', retrieved: '2026-08-14' },
    maxBytes: 240_000,
  },
  cocktailPour: {
    path: '/media/menu/cocktail-pour.jpg',
    kind: 'image',
    alt: 'A mango margarita being poured from a shaker into a Tajín-rimmed glass',
    width: 720,
    height: 900,
    ratio: '4:5',
    focal: '50% 50%',
  ...
  margaritaTajin: {
    path: '/media/menu/margarita-tajin.jpg',
    kind: 'image',
    alt: 'A finished mango margarita with a Tajín rim and a fan of fresh mango',
    width: 720,
    height: 720,
    ratio: '1:1',
    focal: '50% 50%',
  ...
  roomCrowd: {
    path: '/media/home/room-crowd.jpg',
    kind: 'image',
    alt: 'A full dining room at service under the greenery wall and rattan lights',
    width: 720,
    height: 480,
    ratio: '3:2',
    focal: '50% 55%',
