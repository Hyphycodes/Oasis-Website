...
export const EVENT_CATEGORIES = ['nightlife', 'paint-sip', 'brunch', 'comedy', 'special'] as const;
...
export const CATEGORY_FILTERS: EventCategory[] = ['paint-sip', 'brunch', 'nightlife', 'comedy', 'special'];
 ...
 * an accent, a deep surface and a glow, all of which sit on the seasonal canvas.
 */
...
export const DEFAULT_PRESET: VisualPreset = 'marigold';
