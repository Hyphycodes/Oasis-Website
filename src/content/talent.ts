 ...
 * Local talent.
 *
 * Oasis wants to be somewhere a DJ, a painter, a comedian or somebody with a
 * good idea for a night can put their hand up in about a minute. This module
 * is the vocabulary that makes that scannable afterwards: a short closed list
 * of disciplines, the internal statuses, and the map from a discipline onto
 * the `contractors.service_type` it becomes when Oasis actually books them.
 *
 * The list is short on purpose. Every extra category is a decision pushed onto
 * somebody who only wanted to show us what they do, and "Something else" plus
 * their own sentence beats a taxonomy nobody reads.
 */
...
export const TALENT_DISCIPLINES: DisciplineInfo[] = [
  ...
  { id: 'instructor', label: 'Instructor — paint, dance, anything', service: 'instructor' },
