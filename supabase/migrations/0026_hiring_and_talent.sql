...
-- Nothing is published until somebody at Oasis switches it on, and no
...
values
  ('0a515000-0000-4000-8000-000000000101'::uuid, '0a515000-0000-4000-8000-000000000001'::uuid, 'Server',      null, 'either',    false, 10),
  ('0a515000-0000-4000-8000-000000000102'::uuid, '0a515000-0000-4000-8000-000000000001'::uuid, 'Bartender',   null, 'either',    false, 20),
  ('0a515000-0000-4000-8000-000000000103'::uuid, '0a515000-0000-4000-8000-000000000001'::uuid, 'Host',        null, 'part_time', false, 30),
  ('0a515000-0000-4000-8000-000000000104'::uuid, '0a515000-0000-4000-8000-000000000001'::uuid, 'Line cook',   null, 'full_time', false, 40),
  ('0a515000-0000-4000-8000-000000000105'::uuid, '0a515000-0000-4000-8000-000000000001'::uuid, 'Prep cook',   null, 'either',    false, 50),
  ('0a515000-0000-4000-8000-000000000106'::uuid, '0a515000-0000-4000-8000-000000000001'::uuid, 'Busser',      null, 'part_time', false, 60),
  ('0a515000-0000-4000-8000-000000000107'::uuid, '0a515000-0000-4000-8000-000000000001'::uuid, 'Dishwasher',  null, 'either',    false, 70),
  ('0a515000-0000-4000-8000-000000000108'::uuid, '0a515000-0000-4000-8000-000000000001'::uuid, 'Door / security', null, 'part_time', false, 80),
  ('0a515000-0000-4000-8000-000000000109'::uuid, '0a515000-0000-4000-8000-000000000001'::uuid, 'Event staff', null, 'part_time', false, 90)
on conflict (id) do nothing;
...
-- notice that tells Oasis somebody wrote in.
do $$
