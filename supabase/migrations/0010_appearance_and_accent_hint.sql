...
create table if not exists public.appearance (
  ...
  preset                 text not null default 'evening' check (preset in ('evening', 'fiesta', 'muertos', 'daylight')),
  ...
  season                 text not null default 'none' check (season in ('none', 'halloween', 'muertos', 'winter', 'spring')),
