-- Oasis employee operations: locations, employees, requirements, training,
...
--
--   ONE LOCATION MODEL. `locations` exists from this migration and Lockport is
--   its first row. Events, shifts, tasks, incidents and announcements can
--   belong to a location. Existing event rows are backfilled to Lockport, and
...
comment on table public.locations is
  'Every place Oasis operates. Lockport is the first row; Joliet is a second row, not a fork of the code.';

insert into public.locations (id, slug, name, short_name, street, locality, region, postal_code, timezone, phone, sort)
values ('0a515000-0000-4000-8000-000000000001', 'lockport', 'Oasis Lockport', 'Lockport',
        '1250 E. 9th St.', 'Lockport', 'IL', '60441', 'America/Chicago', '(815) 545-7556', 0)
...
comment on table public.employees is
  'One row per person who works at Oasis. user_id links the sign-in; profiles.role says what the account may do. Contractors are a separate table.';
