...
comment on column public.event_occurrences.tax_rate_bps is
  'Basis points. Stays 0 until the accountant confirms these admissions are taxable in Lockport. Never hardcode a rate.';
...
begin
  loop
    candidate := 'OAS-' || public.crockford_random(5);
