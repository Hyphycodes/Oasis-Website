-- Native Oasis Link Hubs: permanent destinations, scheduled modes, composable
...
create table if not exists public.link_hubs (
  ...
  theme                text not null default 'oasis-default',
...
-- The known Lockport destinations come from the same verified source as
-- src/content/site.ts. review_url stays NULL until Oasis supplies its direct
...
insert into public.link_hub_locations (
  ...
  'lockport',
  'Oasis Mexican Kitchen & Bar — Lockport',
  '1250 E. 9th St., Lockport, IL 60441',
  '(815) 545-7556',
  null,
  'https://www.google.com/maps/dir/?api=1&destination=Oasis%20Mexican%20Kitchen%20%26%20Bar%2C%201250%20E%209th%20St%2C%20Lockport%2C%20IL%2060441',
